        ...
        <div className="min-h-screen bg-[#F2F5F8] px-6 py-6 lg:px-10">
            <div className="relative min-h-[calc(100vh-3rem)] rounded-[24px] border border-[#2B2B2B]/10 bg-[#F2F5F8]">
                ...
                <div className="grid min-h-[calc(100vh-3rem)] grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="flex items-center justify-start px-6 py-20 lg:px-16">
                        <div className="w-full max-w-[420px]">
                            <h1 className="text-center text-4xl font-extrabold text-black lg:text-[44px]">
                                SIGN UP
                            </h1>
                            ...
                            >
                                ...
                                <div className="pt-2">
                                    <button
                                        ...
                                        className="mx-auto block min-w-[220px] rounded-full bg-[#2E2E5A] px-8 py-3 text-lg font-bold uppercase tracking-[0.18em] text-white transition hover:bg-[#2B2B2B] disabled:opacity-60"
                                    >
