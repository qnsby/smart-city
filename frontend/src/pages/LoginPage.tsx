              ...
              >
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="mx-auto block min-w-[220-px] rounded-full bg-[#202020] px-10 py-4 text-lg font-bold uppercase tracking-[0.18em] text-white transition hover:bg-[#2B2B2B] disabled:opacity-60"
                  >
