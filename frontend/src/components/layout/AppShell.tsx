  ...
  return (
    <AppShellContext.Provider value={{ collapsed, setCollapsed }}>
      <div className="min-h-screen bg-[#F2F5F8] text-[#202020]">
        <div
          className={`grid min-h-screen gap-4 p-4 transition-all duration-300 ${collapsed ? "grid-cols-[70px_1fr]" : "grid-cols-[300px_1fr]"
            }`}
        >
          <aside
            className={`relative transition-all duration-300 ${collapsed
...
function NavItem({
  ...
  return (
    <NavLink
      to={to}
      className={({ isActive }) =>
        `flex items-center gap-3 rounded-xl px-3 py-3 transition ${isActive
